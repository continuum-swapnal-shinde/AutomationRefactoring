...
public class JunoPlatformStepDefination extends GlobalVariables {
	...
	@Then("^User should fetch the response for API$")
	...
	@And("^User fetch LocalTime from the system$")
	...
	@Then("^User convert the Time to UTC Format$")
	...
	@Then("^User validate the response between stipulated time$")
	...
	@Then("^User should validate the status code as \"([^\"]*)\"No Content$")
	...
	@When("^User send a PUT request as \"([^\"]*)\" with system name$")
	public void i_send_a_PUT_request_as_systemName(String endpoint) throws Throwable {
		try {
			...
			GlobalVariables.scenario.write("User send a PUT request for URL " + url);
	...
	@Then("^User should validate the status code as \"([^\"]*)\"Not Found$")
	...
	@Then("^User should validate the status code as \"([^\"]*)\"Bad Request$")
	...
	@Then("^User should validate the status code as \"([^\"]*)\"Internal Server Error$")
	...
	@When("^User send a PUT request as \"([^\"]*)\" for \"([^\"]*)\" again$")
	...
	@Then("^User validate \"([^\"]*)\" in the get response$")
	...
	@When("^User send a Get request second agent endpoint as \"([^\"]*)\"$")
	public void i_send_a_get_request_second_agent_endpoint_as_something(String endpoint2) throws Throwable {
		try {
			...
			GlobalVariables.scenario.write("User send a Get request for URL " + url);
	...
	@Then("^User should fetch response for API after GZIP decompression$")
	...
	@Then("^User validate the contents of the Service for \"([^\"]*)\"$")
	...
	@And("^User should validate API model for Site API$")
	...
	@Then("^User write the registration data in json$")
	...
	@Then("^User should fetch previous timestamp for \"([^\"]*)\" API$")
	...
	@Then("^User should fetch current timestamp for version$")
	...
	@Then("^User validate system information with version plugin information$")
	...
	@Then("^User validate global manifest file contents with manifest GET API response as \"([^\"]*)\"$")
	...
	@Then("^User should fetch new timestamp for \"([^\"]*)\" API$")
	...
	@Then("^User validate a minute difference between subsequent timestamps$")
	...
	@Then("^User validate difference between subsequent timestamps$")
	...
	@Then("^User should validate the format of Memmory performance response$")
	...
	@Given("^User Start platform service$")
	...
	@Then("^User Close SSH Connection$")
	...
	@Given("^User Start agent microservice$")
	...
	public void i_send_a_Post_request_for_Versioning_of_Agent_Microservice_API(String endpoint) throws Throwable {
		try {
			...
			GlobalVariables.scenario.write("User send a Post request for URL " + url);
			CommonSteps.fetchTestData();
	...
	@When("^User send a Post request for mailbox API endpoint as \"([^\"]*)\"$")
	...
	@When("^User send a configuration restore Post request for mailbox API endpoint as \"([^\"]*)\"$")
	...
	@When("^User send a core configuration change Post request for mailbox API endpoint as \"([^\"]*)\"$")
	...
	@Then("^User fetch and validate schedule json config changes$")
	...
	@Then("^User fetch and validate asset plugin json for MaxFileSize changes as \"([^\"]*)\" on \"([^\"]*)\"$")
	...
	@Then("^User fetch and validate asset plugin json for MaxFileSize changes as \"([^\"]*)\"$")
	...
	@Then("^User fetch and validate ss plugin json for MaxFileSize changes as \"([^\"]*)\" on \"([^\"]*)\"$")
	...
	@Then("^User fetch and validate ss plugin json for MaxFileSize changes as \"([^\"]*)\"$")
	...
	@Then("^User fetch and validate asset plugin json for FileCount changes as \"([^\"]*)\" on \"([^\"]*)\"$")
	...
	@Then("^User fetch and validate asset plugin json for FileCount changes as \"([^\"]*)\"$")
	...
	@Then("^User fetch and validate ss plugin json for FileCount changes as \"([^\"]*)\" on \"([^\"]*)\"$")
	...
	@Then("^User fetch and validate ss plugin json for FileCount changes as \"([^\"]*)\"$")
	...
	@Then("^User fetch and validate performance plugin json for log level changes as \"([^\"]*)\"$")
	...
	@Then("^User fetch and validate performance plugin json from \"([^\"]*)\" for log level changes as \"([^\"]*)\"$")
	...
	@Then("^User fetch and validate event log plugin json \"([^\"]*)\" and \"([^\"]*)\"$")
	...
	@Then("^User fetch and validate performance plugin json for MaxFileSize changes as \"([^\"]*)\" on \"([^\"]*)\"$")
	...
	@Then("^User fetch and validate performance plugin json for MaxFileSize changes as \"([^\"]*)\"$")
	public void i_fetch_and_validate_performance_plugin_json_for_MaxFileSize_changes(String MaxFileSize)
			throws Throwable {
		try {
			Thread.sleep(10000);
	...
	@Then("^User fetch and validate performance plugin json for FileCount changes as \"([^\"]*)\" on \"([^\"]*)\"$")
	...
	@Then("^User fetch and validate performance plugin json for FileCount changes as \"([^\"]*)\"$")
	...
	@Then("^User fetch and validate agent config json from \"([^\"]*)\" for FileCount changes as \"([^\"]*)\"$")
	...
	@When("^User send a Get request for mailbox endpoint as \"([^\"]*)\"$")
	...
	@Given("^User fetch AgentCore EndPointID from agentCore config file$")
	...
	@Given("^User fetch plugin payload from console$")
	...
	@Given("^User fetch performance plugin payload from console$")
	...
	@Given("^User fetch plugin payload from console for windows as \"([^\"]*)\" for \"([^\"]*)\"$")
	...
	@Given("^User configure details on machine with \"([^\"]*)\"$")
	...
	@Given("^User convert time to UTC Format$")
	...
	@When("^User hit DELETE as \"([^\"]*)\" to remove the agent$")
	public void i_hit_delete_as_(String endpoint) throws Throwable {
		try {
			...
			GlobalVariables.scenario.write("User send a DELETE request for URL " + url);
	...
	@Given("^User execute mock set of GlobalVariables.data using Jmeter for \"([^\"]*)\" and \"([^\"]*)\"$")
	...
	@Then("^User write the details to JSON File$")
	...
	@When("^User pass file content as payload in agent-service POST as \"([^\"]*)\"$")
	...
	@When("^User read GET response from performance micro-service and store in file with GET as \"([^\"]*)\"$")
	...
	@Then("^User compare the file contents$")
	...
	@Then("^User compare the file contents for performance$")
	...
	@Then("^User compare the file contents for performance windows$")
	...
	/*
	 * @Then("^User should validate the \"([^\"]*)\" as in GlobalVariables.response$")
	...
	@Given("^User fetch Blank EndPointID from agentCore config file for \"([^\"]*)\"$")
	...
	@Given("^User fetch and Validate plugins for \"([^\"]*)\" from agentCore config file for \"([^\"]*)\"$")
	...
	@Given("^User fetch AgentCore EndPointID from second agentCore config file for \"([^\"]*)\"$")
	...
	@Then("^User should validate response with EndPointID$")
	...
	@Then("^User validate whether event is created successfully with \"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\" and \"([^\"]*)\"$")
	...
	@And("^User should validate the response of Heartbeat API as \"([^\"]*)\"$")
	...
	@And("^User should validate the response Multiple Endpoints based on PartnerID \"([^\"]*)\"$")
	...
	@When("^User pass payload for site mapping POST as \"([^\"]*)\"$")
	public void i_pass_payload_for_site_mapping_POST_as(String endpoint) throws Throwable {
		try {
			String url;
			url = Utilities.getMavenProperties("Agent-Service-ELB") + endpoint;
			scenario.write("User send a Post request for URL " + url);
	...
	@When("^User pass payload for site mapping POST as \"([^\"]*)\" again$")
	...
	@Then("^User again compare the siteIdValue for the above endpoint$")
	...
	@Then("^User fetch EndPointID of the machine for \"([^\"]*)\"$")
	...
	@When("^User read GET response from a micro-service for realtime and store in file with GET as \"([^\"]*)\"$")
	...
	@Then("^User validate system information with micro-service information for \"([^\"]*)\"$")
	...
	@When("^User pass content as payload in agent-service POST as \"([^\"]*)\"$")
	...
	@When("^User send a PUT request as \"([^\"]*)\" for \"([^\"]*)\"$")
	...
	@When("^User read GET response from a micro-service and store in file with GET as \"([^\"]*)\"$")
	...
	@When("^User read GET response from a micro-service and store in file with GET as \"([^\"]*)\" with Content Encoding$")
	...
	@And("^User fetch Information for \"([^\"]*)\" from the system$")
	...
	@And("^User fetch version Information from the system$")
	...
	@Then("^User validate the File Information with the expected result for \"([^\"]*)\"$")
	...
	@Then("^User validate system information with plugin information$")
	...
	@Then("^User validate if system ready for autoupdate feature$")
	...
	@Then("^User validate system information with plugin information wrt lastLoggedOnUser$")
	...
	@Then("^User validate system information with plugin information for system state$")
	...
	/* Added by sampada */
	@Given("^User send a performance plugin configuration change Post request for mailbox API endpoint as \"([^\"]*)\"$")
	...
	@Given("^User send a performance plugin configuration change Post request for single endpoint to mailbox API endpoint as \"([^\"]*)\"$")
	...
	@Given("^User send a agent configuration change Post request for multiple endpoints to mailbox API endpoint as \"([^\"]*)\"$")
	...
	@Given("^User send a agent configuration change Post request for single endpoints to mailbox API endpoint as \"([^\"]*)\"$")
	...
	@Then("^User fetch and validate performance plugin json for log level changes as \"([^\"]*)\" on \"([^\"]*)\"$")
	...
	@Given("^User send a asset plugin configuration change Post request for mailbox API endpoint as \"([^\"]*)\"$")
	...
	@Then("^User fetch and validate asset plugin json for log level changes as \"([^\"]*)\" on \"([^\"]*)\"$")
	...
	@Then("^User fetch and validate asset plugin json for log level changes as \"([^\"]*)\" in monitoring$")
	...
	@Then("^User fetch and validate ss plugin json for log level changes as \"([^\"]*)\" on \"([^\"]*)\"$")
	...
	@Then("^User fetch and validate ss plugin json for log level changes as \"([^\"]*)\"$")
	...
	@Then("^User should validate the status code in resonse as \"([^\"]*)\"$")
	...
	@Then("^User should fetch messageID from API response for API$")
	...
	@Then("^User compare the file contents for \"([^\"]*)\"$")
	...
	@Then("^User compare version contents$")
	...
	@Then("^User validate the DG Attributes$")
	...
	@Then("^User validate the contract of Asset MS$")
	...
	@Then("^User should validate Content Encoding for API$")
	...
	@And("^User validate the agent core LogFile \"([^\"]*)\" and \"([^\"]*)\"$")
	...
	@And("^User clears the Agent Core Log File \"([^\"]*)\"$")
	...
	@Given("^SSH connection establishes with remote test machine for \"([^\"]*)\"$")
	...
	@Given("^User fetch AgentCore EndPointID from agentCore config file for \"([^\"]*)\"$")
	...
	@And("^User fetch and validate scripting plugin log level changes as \"([^\"]*)\" and \"([^\"]*)\"$")
	...
	@And("^User fetch and validate scripting plugin log level changes as \"([^\"]*)\"$")
	...
	@When("^User send a delete request for API endpoint as \"([^\"]*)\"$")
	...
	@And("^User should validate the response of Heartbeat API with Installed flag \"([^\"]*)\"$")
	...
	@Then("^User should validate the response of registration API$")
	...
	@When("^User send a POST request for API endpoint with header as \"([^\"]*)\"$")
	...
	@Then("^User should fetch endpointID from API response$")
	...
	@Then("^User validate the configuration file is environment specific as \"([^\"]*)\" and \"([^\"]*)\"$")
	...
	@When("^User connect to cassandra DB$")
	...
	@When("^User fetch token table entries from cassandra DB$")
